          ...
          {displayStatus === 'success' && courses.length > 0 && (
            <>
              ...
              <div className="grid gap-4">
                {courses.map((course) => (
                  <Link key={course.course_code} to={`/courses/${course.course_code}`} className="block bg-white border border-gray-100 rounded-2xl p-5 sm:p-6 shadow-sm hover:shadow-md hover:border-orange-200 transition group">
